    ...
    <>
      {pageCount !== 0 ? (
        ...
        >
          ...
          {(paginationRowRange?.lastRowIndex as number) + 1} of {available} Distributions
        </Typography>
      ) : (
        <Typography
          variant="body2"
          ...
          ml={belowSmallScreen ? 'auto' : ''}
        >
          Showing 0 - 0 of {available} Distributions
        </Typography>
      )}
      <MuiPagination
        color="primary"
...
export default function UserDistributionsPagination(props: object) {
